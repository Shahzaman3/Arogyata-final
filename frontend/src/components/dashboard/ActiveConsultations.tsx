import { Clock, Eye, User, Loader2, RefreshCw } from 'lucide-react';
            ...
            <>
                  <Card className="glass-card border-cyan-500/20">
                        <CardHeader className="flex flex-row items-center justify-between">
                              ...
                              <Button variant="ghost" size="icon" onClick={fetchConsultations} disabled={isLoading}>
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                                          {consultations.map((consult) => (
                                                ...
                                                >
                                                      ...
                                                      <Button
                                                            size="sm"
                                                            className="w-full bg-cyan-600/20 hover:bg-cyan-600/30 text-cyan-400 border border-cyan-500/30"
                                                            onClick={() => setSelectedPatient({
                                                                  id: consult.owner._id,
                                                                  name: consult.owner.name || consult.owner.email
                                                            })}
                                                      >
